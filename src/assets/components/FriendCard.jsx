...
const FriendCard = ({ friendId, friendName }) => {
    ...
    useEffect(() => {
        ...
        const fetchUnreadCount = async () => {
            try {
                const count = await SupabaseAPI.getUnreadMessagesCount(user.id, friendId);
        ...
        const statusChannel = SupabaseAPI.subscribeToFriendStatus(friendId, setUserStatus);
        const unreadMessagesChannel = SupabaseAPI.subscribeToUnreadMessages(user.id, friendId, setUnreadCount);
